...
<Tile href="/components/accordions" title="Accordion" description="Two variants">
  <img src="/images/partners_light.png" alt="Accordion component preview" className="block dark:hidden" />
  <img src="/images/partners.png" alt="Accordion component preview (dark mode)" className="hidden dark:block" />
</Tile>

<Tile href="/components/accordions" title="Ecosystem Partners" description="build on">
  <img src="/images/partners_light.svg" alt="Accordion component preview" className="block dark:hidden" />
  <img src="/images/partners.svg" alt="Accordion component preview (dark mode)" className="hidden dark:block" />
</Tile>

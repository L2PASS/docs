...
<Steps>
  ...
  <Step title="Mint Position NFT">
    ...
    <Info>
      ...
      The NFT is minted only once per user. Subsequent deposits do not require NFT minting and typically cost **35–40% less** in network resources.
    </Info>
  </Step>
  ...
  <Step title="Claim Rewards / Withdraw Principal">
    ...
    <Info>
      Rewards earned during completed epochs remain claimable even after the user has fully exited the position.  
      The interface continues to display eligible reward epochs until all rewards are claimed.
    </Info>
  </Step>

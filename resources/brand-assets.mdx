...
<CardGroup cols={2}>
  ...
  <Card title="Logo Dark (SVG)" icon="bezier-curve" href="/brand_assets/l2pass_logo_dark.svg">
    <div style={{ display: "flex", justifyContent: "center", padding: "1rem", backgroundColor: "#FCFAF7" }}>
...
<CardGroup cols={2}>
  ...
  <Card title="Logo Dark (PNG)" icon="file-image" href="/brand_assets/l2pass_logo_dark.png">
    <div style={{ display: "flex", justifyContent: "center", padding: "1rem", backgroundColor: "#FCFAF7", height: "144px"  }}>

...
<CardGroup cols={2}>
  <Card title="Logo Light (SVG)" icon="bezier-curve" href="/brand_assets/l2pass_logo_light.svg">
    ...
    Standard vector wordmark for dark-themed layouts.
  </Card>
  ...
  <Card title="Logo Dark (SVG)" icon="bezier-curve" href="/brand_assets/l2pass_logo_dark.svg">
    ...
    Standard vector wordmark for light-themed layouts.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Logo Light (PNG)" icon="file-image" href="/brand_assets/l2pass_logo_light.png">
    ...
    High-resolution raster image with transparency.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Polar Dark (SVG)" icon="bolt" href="/brand_assets/l2pass_logo_polar_dark.svg">
    <div style={{ display: "flex", justifyContent: "center", padding: "1rem" }}>
  ...
  <Card title="Polar Light (SVG)" icon="bolt" href="/brand_assets/l2pass_logo_polar_light.svg">
    <div style={{ display: "flex", justifyContent: "center", padding: "1rem" }}>
...
<CardGroup cols={2}>
  ...
  <Card title="App Icon" icon="square" href="/assets/icon.png">
    <div style={{ display: "flex", justifyContent: "center", padding: "1rem" }}>
      <img src="/assets/icon.png" style={{ height: "80px", borderRadius: "12px" }} />
    </div>
    Square app icon for social media and favicons.
  </Card>
</CardGroup>

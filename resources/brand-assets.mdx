...
<CardGroup cols={2}>
  <Frame caption="L2Pass Logo (Light on Dark)">
    <img 
      src="/brand_assets/l2pass_logo_light.svg" 
      style={{ backgroundColor: "#FCFAF7", padding: "2rem", borderRadius: "0.5rem" }} 
    />
  </Frame>
  <Frame caption="L2Pass Logo (Transparent)">
    <img 
      src="/brand_assets/l2pass_logo_light.svg" 
      style={{ padding: "2rem", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "0.5rem" }} 
    />
  </Frame>
</CardGroup>
...
### Polar Variation (SVG)
<CardGroup cols={2}>
  <Frame caption="Polar Light (On White)">
    <img 
      src="/brand_assets/l2pass_logo_polar_light.svg" 
      style={{ backgroundColor: "#1A1A1A", padding: "2rem", borderRadius: "0.5rem" }} 
    />
  </Frame>
  <Frame caption="Polar Light (On Dark)">
    <img 
      src="/brand_assets/l2pass_logo_polar_light.svg" 
      style={{ backgroundColor: "#FCFAF7", padding: "2rem", borderRadius: "0.5rem" }} 
    />

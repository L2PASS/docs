...
<CardGroup cols={2}>
  <Card title="Logo Light, svg" icon="bezier-curve" href="/brand_assets/l2pass_logo_polar_dark.svg">
    <div style={{ display: "flex", justifyContent: "center", padding: "1rem" }}>
  ...
  <Card title="Logo Dark, svg" icon="bezier-curve" href="/brand_assets/l2pass_logo_polar_light.svg">
    <div style={{ display: "flex", justifyContent: "center", padding: "1rem" }}>
...
### Icons & Symbols
  ...
  <Card title="L2P Logo, Dark BG" icon="bezier-curve" href="/assets/icon.png">
    <div style={{ display: "flex", justifyContent: "center", padding: "1rem" }}>

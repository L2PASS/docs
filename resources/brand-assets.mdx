...
### Primary Wordmarks
<CardGroup cols={2}>
  <Card title="Wordmark Light" icon="download" href="/brand_assets/l2pass_logo_light.svg">
  ...
  <Card title="Wordmark Polar" icon="download" href="/brand_assets/l2pass_logo_polar_light.svg">
    <div style={{ display: "flex", justifyContent: "center", padding: "1rem" }}>
...
### Icons & Symbols
<CardGroup cols={2}>
  <Card title="L2Pass Star" icon="star" href="/brand_assets/l2pass_star.svg">
    <div style={{ display: "flex", justifyContent: "center", padding: "1rem" }}>
  ...
  <Card title="App Icon" icon="square" href="/assets/icon.png">
    <div style={{ display: "flex", justifyContent: "center", padding: "1rem" }}>
